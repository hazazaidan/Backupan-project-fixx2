...
class App {
    ...
    public function __construct() {
        ...
        $fullRouteMap = [
            ...
            'admin/siswa/store'       => ['AdminController', 'storeSiswa'],
            'admin/siswa/update'      => ['AdminController', 'updateSiswa'],
            'admin/siswa/destroy'     => ['AdminController', 'destroySiswa'],
            'admin/guru'              => ['AdminController', 'guru'],
            'admin/guru/store'        => ['AdminController', 'storeGuru'],
            'admin/guru/update'       => ['AdminController', 'updateGuru'],
            'admin/guru/destroy'      => ['AdminController', 'destroyGuru'],
            'admin/kelas'             => ['AdminController', 'kelas'],
            'admin/kelas/store'       => ['AdminController', 'storeKelas'],
            'admin/kelas/update'      => ['AdminController', 'updateKelas'],
            'admin/kelas/destroy'     => ['AdminController', 'destroyKelas'],
            ...
            'admin/pengaturan/save'        => ['AdminController', 'savePengaturan'],
            'admin/pengaturan/tambah-libur' => ['AdminController', 'tambahLibur'],
            'admin/pengaturan/hapus-libur'  => ['AdminController', 'hapusLibur'],
            'admin/pengaturan/get-libur'    => ['AdminController', 'getLibur'],
